  ...
  return (
    <div
      class={[
        ...
        props.class,
        style['layout-button-tab'],
        { [style['layout-button-tab_dark']]: props.darkMode },
        { [style['layout-button-tab_active']]: props.active },
        { [style['layout-button-tab_active_dark']]: props.active && props.darkMode }
      ]}
      style={props.style}
    >
      {slots.prefix?.()}
